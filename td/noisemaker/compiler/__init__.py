"""Polymorphic DSL compiler — Python port of the noisemaker-for-unity C# `Compiler/`.

Mirrors `noisemaker-for-unity/unity/com.noisemaker.hlsl/Compiler/` file-for-file, which is
