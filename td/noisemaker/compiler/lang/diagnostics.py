...
_TABLE = {
    ...
    'P008': ("Unknown subchain argument key", SEVERITY_WARNING, STAGE_PARSER),
    'P009': ("Duplicate subchain argument key", SEVERITY_WARNING, STAGE_PARSER),
    'P010': ("Missing ',' between subchain arguments", SEVERITY_WARNING, STAGE_PARSER),
